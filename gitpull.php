...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <h1 class="w3-xxxlarge">ThingML Cloud Tests</h1>
	...
	<ul class="w3-navbar w3-theme">
	  ...
	  <li><a class="w3-dark-grey w3-padding-16" href="gitpull.php">Git Pull</a></li>
	  <li><a class="w3-padding-16" href="runtests.php">Run Tests</a></li>
	...
	<div class="w3-container w3-card-4">
		<hr>
			<?php
				...
				$cmd1 = $cmd_prefix."/thingml/ThingML/git_pull.sh";
				//exec('(ping -c 20 127.0.0.1 > /app/web/gitPullRes 2>&1)&');
				echo $cmd1."<br />";
				exec("(".$cmd1.")&");
			?>
		<hr>
		<iframe id="cmd-results" name="cmd-results" src="git_pull_log" style="width: 100%; height: 500px"></iframe>
		<hr>
	</div>
</div>
